...
use messe_core::group::{GroupMessage, GroupState, SenderKeyDistribution};
...
mod tests {
    ...
    fn sample(id: &str) -> StoredGroup {
        ...
        struct P(u8);
        impl messe_core::platform::Platform for P {
        ...
        let group = messe_core::group::Group::new(&mut P(1), b"me".to_vec());
        StoredGroup {
            id: id.into(),
            name: "team".into(),
